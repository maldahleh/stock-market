...
class StockPlayerTests {
  ...
  void performTransactions() {
    // GIVEN
    Transaction purchase = buildTransaction(TransactionType.PURCHASE, 3, BigDecimal.TEN);
    Transaction sale = buildTransaction(TransactionType.SALE, 2, BigDecimal.ONE);
  ...
  private Transaction buildTransaction(TransactionType type, int quantity, BigDecimal stockValue) {
